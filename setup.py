...
setup(name='dockeroo',
    ...
    entry_points = {
        'zc.buildout': [
            ...
            'docker.load = dockeroo.docker.load:DockerLoadRecipe',
            ...
            'docker.save = dockeroo.docker.save:DockerSaveRecipe',
        ...
        'zc.buildout.uninstall': [
            ...
            'docker.load = dockeroo.docker.load:DockerLoadRecipe._uninstall',
            ...
            'docker.save = dockeroo.docker.save:DockerSaveRecipe._uninstall',
